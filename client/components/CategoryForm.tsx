...
const CategoryForm = ({id}: {id:string}) => {
    ...
    return(
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4 p-4 bg-gray-200 rounded-lg">
            <h2 className="text-l font-bold text-center">Add Category</h2>
            ...
            <button type="submit" className="bg-blue-400 font-bold w-full cursor-pointer hover:bg-blue-300">Add Category</button>
        </form>
    )
}
